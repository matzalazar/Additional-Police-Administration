...
SECRET_KEY = 'oecuh9=8%#pufev48%y+7n2%-=y&o^q(9p^puzphx!v4+z))-6'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),  # Ruta donde se guardará la base de datos
    }
}
